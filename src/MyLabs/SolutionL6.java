...
public class SolutionL6{
	...
	private static void CallEditMenu(FileList fileList, byte id) throws Exception {
		...
		byte n;
		do {
			System.out.println("Оберіть параметр для редагування:");
			System.out.println("1 - Назва файлу;");
			System.out.println("2 - Розширення файлу;");
			System.out.println("3 - Розмір файлу;");
			System.out.println("4 - Дата створення файлу;");
			System.out.println("5 - Атрибути файлу;");
	...
	private static void CallRemoveMenu(FileList fileList) {
		byte n;
		do {
			System.out.println("Оберіть параметр для вилучення:");
			System.out.println("1 - Вилучення за порядковим номером;");
			System.out.println("2 - Вилучення за назвою;");
			System.out.println("3 - Вилучення за розширенням;");
			System.out.println("4 - Вилучення за розміром;");
			System.out.println("5 - Вилучення за датою створення;");
			System.out.println("6 - Вилучення за атрибутами;");
			System.out.println("0 - Вихід;");
			n = MyUtils.MyScanner.in.nextByte();
		} while(n < 0 || n > 6);
	...
	private static void CallMenuForSolve2(FileList fileList) throws IOException {
		while(true) {
			...
			do {
				...
				System.out.println("1 - Виведення інформації про файли на екран;");
				System.out.println("2 - Додати новий запис;");
				System.out.println("3 - Вилучити запис;");
				System.out.println("4 - Пошук записів(за датою створення);");
				System.out.println("5 - Сортування записів(за розширенням);");
				System.out.println("6 - Редагування записів;");
				System.out.println("0 - Вихід;");
				n = MyUtils.MyScanner.in.nextByte();
			}	while(n < 0 || n > 6);
